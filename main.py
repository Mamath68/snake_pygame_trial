...
class Apple:
    def __init__(self, parent_screen):
        ...
        self.apple = pygame.image.load("ressources/apple.jpg").convert()
        self.x = 120
        self.y = 120
...
def play_background_music():
    pygame.mixer.music.load('ressources/bg_music_1.mp3')
    pygame.mixer.music.play(-1, 0)


def play_sound(sound_name):
    if sound_name == "crash":
        sound = pygame.mixer.Sound("ressources/crash.mp3")
    elif sound_name == 'ding':
        sound = pygame.mixer.Sound("ressources/ding.mp3")
